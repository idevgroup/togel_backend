...
<div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
    ...
    <div class="m-portlet__body">
        <div class="form-group m-form__group row @if ($errors->has('name')) has-danger @endif">
            {!!Form::label('name', trans('labels.gamemarketname'),['class' => 'col-sm-3 col-form-label required'])!!}
            <div class="col-sm-5">
        ...
        <div class="form-group m-form__group row @if ($errors->has('code')) has-danger @endif">
            {!!Form::label('code', trans('labels.codename'),['class' => 'col-sm-3 col-form-label required'])!!}
            <div class="col-sm-5">
