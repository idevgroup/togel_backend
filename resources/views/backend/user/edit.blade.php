...
<div class="m-portlet m-portlet--mobile">
    {!!Form::open(['url' =>url(_ADMIN_PREFIX_URL.'/useraccounts/'.$user->id),'class' =>'m-form m-form--fit m-form--label-align-right','method' => 'PATCH'])!!}
    <div class="m-portlet__head">
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                    {{trans('menu.user').' / '.trans('trans.edit')}}
                </h3>
            </div>
        </div>
