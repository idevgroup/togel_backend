...
@push('title',trans('menu.dreambook').'-'.trans('trans.create'))
@section('content')
    {!!Form::open(['url' =>url(_ADMIN_PREFIX_URL.'/dreambooks'),'class' =>' m-form--state m-form m-form--fit m-form--label-align-right','id'=>'idev-form','files'=>true])!!}
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            {{trans('menu.dreambook').' / '.trans('trans.create')}}
                        </h3>
                    </div>
                </div>
        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row @if ($errors->has('txtname')) has-danger @endif">
                {!!Form::label('name',trans('labels.dreambookname'),['class' => 'col-sm-3 col-form-label required'])!!}
                <div class="col-sm-5">
