...
@push('title',trans('menu.bankaccountgroup').'-'.trans('trans.edit'))
@section('content')
    ...
    <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
        ...
        <div class="m-portlet__body">
            <div class="form-group m-form__group row @if ($errors->has('bank_group')) has-danger @endif">
                ...
                <div class="col-sm-5">
                    {!!Form::select('bank_group',$bank_group,old('bank_group',$record->bank_group_id),['class'=>'form-control m-input'])!!}
