    ...
    <div class="m-content">
                    ...
                    <div class="m-portlet__body">
                        <div class="m-widget27 m-portlet-fit--sides">
                            <div class="m-widget27__pic">
                                <img src="{{asset('backend/assets/app/media/img//bg/bg-4.jpg')}}" alt="">
            ...
            <div class="col-xl-6">
                            ...
                            <div class="m-widget3__item">
                                <div class="m-widget3__header">
                                    <div class="m-widget3__user-img">
                                        <img class="m-widget3__img" src="{{asset('backend/assets/app/media/img/users/user1.jpg')}}" alt="">
                                    </div>
              ...
              Pending
                            ...
                            <div class="m-widget3__item">
                                <div class="m-widget3__header">
                                    <div class="m-widget3__user-img">
                                        <img class="m-widget3__img" src="{{asset('backend/assets/app/media/img/users/user4.jpg')}}" alt="">
                                    </div>
                                    <div class="m-widget3__info">
                                        <span class="m-widget3__username">
                Lebron King James
              ...
              Open
                            ...
                            <div class="m-widget3__item">
                                <div class="m-widget3__header">
                                    <div class="m-widget3__user-img">
                                        <img class="m-widget3__img" src="{{asset('backend/assets/app/media/img/users/user5.jpg')}}" alt="">
                                    </div>
                                    <div class="m-widget3__info">
                                        <span class="m-widget3__username">
                Deb Gibson
                                ...
                                <div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
                                    ...
                                    <div class="m-timeline-2__item m--margin-top-30">
                                        ...
                                        <div class="m-list-pics m-list-pics--sm m--padding-left-20">
                                            <a href="#"><img src="{{asset('backend/assets/app/media/img/users/100_4.jpg')}}" title=""></a>
                                            <a href="#"><img src="{{asset('backend/assets/app/media/img/users/100_13.jpg')}}" title=""></a>
                                            <a href="#"><img src="{{asset('backend/assets/app/media/img/users/100_11.jpg')}}" title=""></a>
                                            <a href="#"><img src="{{asset('backend/assets/app/media/img/users/100_14.jpg')}}" title=""></a>
                                        </div>
                                    </div>
                                    <div class="m-timeline-2__item m--margin-top-30">
        ...
        <div class="row">
                                    ...
                                    <div class="m-widget5__item">
                                        <div class="m-widget5__content">
                                            <div class="m-widget5__pic">
                                                <img class="m-widget7__img" src="{{asset('backend/assets/app/media/img//products/product6.jpg')}}" alt="">
                                            </div>
                    ...
                    Make Metronic Great Again.Lorem Ipsum Amet
                      ...
                      23.08.17
                                    ...
                                    <div class="m-widget5__item">
                                        <div class="m-widget5__content">
                                            <div class="m-widget5__pic">
                                                <img class="m-widget7__img" src="{{asset('backend/assets/app/media/img//products/product10.jpg')}}" alt="">
                                            </div>
                                            <div class="m-widget5__section">
                                                <h4 class="m-widget5__title">
                                                    Branding Mockup
                    ...
                    Make Metronic Great Again.Lorem Ipsum Amet
                      ...
                      23.08.17
                                    ...
                                    <div class="m-widget5__item">
                                        <div class="m-widget5__content">
                                            <div class="m-widget5__pic">
                                                <img class="m-widget7__img" src="{{asset('backend/assets/app/media/img//products/product11.jpg')}}" alt="">
                                            </div>
                                            <div class="m-widget5__section">
                                                <h4 class="m-widget5__title">
                                                    Awesome Mobile App
            ...
            <span class="m-widget4__number m--font-brand">+$2500</span>
                            ...
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img src="{{asset('backend/assets/app/media/img/client-logos/logo4.png')}}" alt="">
                                </div>
                                <div class="m-widget4__info">
                                    <span class="m-widget4__title">
              StarBucks
            ...
            <span class="m-widget4__number m--font-brand">-$290</span>
                            ...
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img src="{{asset('backend/assets/app/media/img/client-logos/logo3.png') }}" alt="">
                                </div>
                                <div class="m-widget4__info">
                                    <span class="m-widget4__title">
              Phyton
            ...
            <span class="m-widget4__number m--font-brand">+$17</span>
                            ...
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img src="{{asset('backend/assets/app/media/img/client-logos/logo2.png')}}" alt="">
                                </div>
                                <div class="m-widget4__info">
                                    <span class="m-widget4__title">
              GreenMakers
            ...
            <span class="m-widget4__number m--font-brand">-$2.50</span>
                            ...
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img src="{{asset('backend/assets/app/media/img/client-logos/logo1.png')}}" alt="">
                                </div>
                                <div class="m-widget4__info">
                                    <span class="m-widget4__title">
              FlyThemes
