...
@push('title',trans('menu.post').'-'.trans('trans.edit'))
@section('content')
{!!Form::open(['url' =>url(_ADMIN_PREFIX_URL.'/posts/'.$post->id),'class' =>' m-form--state m-form m-form--fit m-form--label-align-right','id'=>'idev-form','files'=>true,'method' => 'PATCH'])!!}
<div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        {{trans('menu.post').' / '.trans('trans.edit')}}
                    </h3>
                </div>
            </div>
    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row @if ($errors->has('txtname')) has-danger @endif">
            ...
            <div class="col-sm-5">
                {!!Form::text('txtname',old('txtname',$post->name),['class' => 'form-control m-input','id'=>'name'])!!}
        ...
        <div class="form-group m-form__group row @if ($errors->has('txtslug')) has-danger @endif">
            ...
            <div class="col-sm-5">
                ...
                {!!Form::text('txtslug',old('txtslug',$post->slug),['class' => 'form-control m-input','id' => 'slug' ,'readOnly'])!!}
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-sm-5">
                {!!Form::select('category_id',$get_parent,old('category_id',$post->category_id),['class'=>'form-control m-input'])!!}
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-sm-7">
                {!!Form::textarea('shortdesc',old('shortdesc',$post->description),['rows' => 8,'class' => 'form-control m-input cms-editor'])!!}
            </div>
        </div>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-sm-5">
                <input data-switch="true" type="checkbox" value="{{$post->status}}" {{($post->status == 1)?'checked':''}} name="status" data-on-color="success" data-off-color="warning">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-sm-5">
                {!!Form::text('txtmetakey',old('txtmetakey',$post->meta_key),['class' => 'form-control m-input','id' => 'metakeyword','data-role'=> 'tagsinput'])!!}
            </div>
        </div>
        <div class="form-group m-form__group row">
            {!!Form::label('metadesc','Meta Description',['class' => 'col-sm-3 col-form-label'])!!}
            <div class="col-sm-5">
                {!!Form::textarea('txtmetadesc',old('txtmetadesc',$post->meta_desc),['class' => 'form-control m-input'])!!}
            </div>
        </div>
    </div>
